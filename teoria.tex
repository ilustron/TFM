...
Las componentes del tensor de curvatura TAL son normales a la superficie
...
K&=K_1K_2\equiv \det(K_{\alpha\beta})=\frac{1}{2}(K_{\alpha}^{\ \beta}K_{\alpha}^{\ \beta}-K_{\alpha}^{\ \alpha}K_{\beta}^{\ \beta})
\end{align}
